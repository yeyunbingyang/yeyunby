...
### 1.1 配置大模型
![image-20250304150734862](image-20250304150734862.png))

#### ① 深度求索API
![image-20250304150902760](image-20250304150902760.png))
![image-20250304151003895](image-20250304151003895.png))

#### ② 兼容OpenAI API的供应商

如果待配置的模型供应商没有出现在官方提供的列表中，可以选择兼容OpenAI API的供应商，几乎所有供应商都兼容OpenAI API规范。
![image-20250304151226708](image-20250304151226708.png))

**以腾讯云为例**
![image-20250304152606171](image-20250304152606171.png))
![image-20250304152404903](image-20250304152404903.png))

**模型名称**需要在腾讯云官方提供的API文档查询
![image-20250304152008367](image-20250304152008367.png))
...
#### ① 下载与安装
![image-20250312144431637](image-20250312144431637.png))

这些插件需要在工具中搜索并安装：
![image-20250312144623393](image-20250312144623393.png))

需要注意的是，电子邮件需要在精选中查找：
![image-20250312144648339](image-20250312144648339.png))

#### ② google搜索授权

**注意：搜索工具需要授权，按照提示跳转至官网申请API Key即可。**
![image-20250311214913244](image-20250311214913244.png))
![image-20250311214927084](image-20250311214927084.png))
![image-20250311214949725](image-20250311214949725.png))
![image-20250311215206193](image-20250311215206193.png))

粘回来：
![image-20250311215238133](image-20250311215238133.png))

#### ③ Firecrawl授权

授权过程：
![image-20250311220854998](image-20250311220854998.png))
![image-20250311220911800](image-20250311220911800.png))
![image-20250311221008112](image-20250311221008112.png))
![image-20250311221035711](image-20250311221035711.png))

#### ④ 电子邮件授权

需要授权，方式如下
![image-20250305145900652](image-20250305145900652.png))
...
密码如何获取呢？
![image-20250311233652465](image-20250311233652465.png))
![image-20250311233707070](image-20250311233707070.png))
...
![image-20250304143240677](image-20250304143240677.png))
...
![image-20250304143441047](image-20250304143441047.png))
![image-20250304143525956](image-20250304143525956.png))
...
![image-20250304143712665](image-20250304143712665.png))
...
![image-20250304143805581](image-20250304143805581.png))

#### 2.2.2 配置输入

通过`/`或`{`唤起变量菜单，如下
![image-20250304144634931](image-20250304144634931.png))

此处将target变量作为搜索工具节点的输入
![image-20250304144715072](image-20250304144715072.png))

#### 2.2.3 配置输出

输出数据格式固定，如下
![image-20250304145420148](image-20250304145420148.png))

#### 2.2.4 测试
![image-20250304150535536](image-20250304150535536.png))

输入：

搜索框写入`中美两国AI发展现状`
![image-20250304174917652](image-20250304174917652.png))

输出：
![image-20250304175005387](image-20250304175005387.png))
...
#### 2.3.1 创建节点
![image-20250304145453391](image-20250304145453391.png))

#### 2.3.2 配置输入

定义输入变量json，其值选择搜索节点输出中的json对象
![image-20250304145755193](image-20250304145755193.png))

#### 2.3.3 编写代码

语言选择Python3，并写入代码，输出变量定义为result，类型为Array[Object]，如下
![image-20250304145855371](image-20250304145855371.png))
...
输出
![image-20250304175231735](image-20250304175231735.png))
...
#### 2.4.1 创建
![image-20250304145951223](image-20250304145951223.png))

#### 2.4.2 选择输入
![image-20250304150332344](image-20250304150332344.png))
...
###### ② 配置输入
![image-20250304174635356](image-20250304174635356.png))
![image-20250304174721618](image-20250304174721618.png))

###### ③ 编写代码
![image-20250305111031472](image-20250305111031472.png))
...
参数填写如下
![image-20250304175507030](image-20250304175507030.png))

**2. 测试结果如下**
![image-20250304175524572](image-20250304175524572.png))
...
此处用到firecrawl提供的工具，需要去后者的官网https://www.firecrawl.dev/获取API Key
![image-20250304175839119](image-20250304175839119.png))

###### ② 配置
![image-20250305100640293](image-20250305100640293.png))
...
输出变量格式如下
![image-20250305100824873](image-20250305100824873.png))

###### ④ 测试

1. 输入
![image-20250305100919156](image-20250305100919156.png))
...
2. 测试结果如下
![image-20250305101340468](image-20250305101340468.png))
...
###### ① 创建
![image-20250305102402756](image-20250305102402756.png))

###### ② 选择模型
![image-20250305102536699](image-20250305102536699.png))



###### ③ 配置提示词
![image-20250813225602583](image-20250813225602583.png))
...
![image-20250305104848545](image-20250305104848545.png))
...
**2. 输出**
![image-20250305105347380](image-20250305105347380.png))
...
#### 2.4.4 配置输出和并行度
![image-20250305105527381](image-20250305105527381.png))
...
#### 2.5.1 创建
![image-20250305105733146](image-20250305105733146.png))

#### 2.5.2 配置输入
![image-20250305105826996](image-20250305105826996.png))

#### 2.5.3 编写代码
![image-20250305105927321](image-20250305105927321.png))
...
#### 2.5.4 配置输出变量
![image-20250305110008713](image-20250305110008713.png))
...
```
![image-20250305115231138](image-20250305115231138.png))

##### 2. 输出
![image-20250305115246642](image-20250305115246642.png))
...
#### 2.6.2 配置
![image-20250813231403075](image-20250813231403075.png))
...
中美两国AI发展现状
```
![image-20250305143200691](image-20250305143200691.png))

##### 2. 输出

API请求超时，切换为内置模型测试。
![image-20250305143307432](image-20250305143307432.png))
...
#### 2.7.1 创建
![image-20250305141107643](image-20250305141107643.png))

#### 2.7.2 配置模型及输入变量
![image-20250305141242343](image-20250305141242343.png))

> 这里也可以改为硅基流动的DeepSeek-V3模型试试。

#### 2.7.3 配置提取参数
![image-20250305141301788](image-20250305141301788.png))
![image-20250305141336783](image-20250305141336783.png))

#### 2.7.4 配置提示词
![image-20250305141426194](image-20250305141426194.png))
...
#### 2.7.5 输出变量
![image-20250305141521813](image-20250305141521813.png))

#### 2.7.6 测试

将LLM2节点输出的text字段作为输入
![image-20250305141621852](image-20250305141621852.png))
...
**输出内容如下**
![image-20250305141703083](image-20250305141703083.png))
...
#### 2.8.2 配置输入
![image-20250305142217678](image-20250305142217678.png))
...
###### 1. 创建
![image-20250305142354309](image-20250305142354309.png))

###### 2. 配置
![image-20250305143515520](image-20250305143515520.png))
...
**2. 输出**
![image-20250305144432064](image-20250305144432064.png))
...
#### 2.8.4 配置输出和并行度
![image-20250305145110390](image-20250305145110390.png))
...
#### 2.10.2 创建节点
![image-20250305152406232](image-20250305152406232.png))

#### 2.10.3 配置
![image-20250814000116555](image-20250814000116555.png))
![image-20250305152509271](image-20250305152509271.png))

#### 2.9.4 测试
![image-20250814000333926](image-20250814000333926.png))
...
**运行日志**
![image-20250814000533483](image-20250814000533483.png))

**查看目标邮箱**
![image-20250814000619781](image-20250814000619781.png))
...
#### 2.10.1 创建
![image-20250305153008125](image-20250305153008125.png))

#### 2.10.2 配置
![image-20250305153143552](image-20250305153143552.png))

### 2.11 试运行

#### 2.11.1 试运行
![image-20250305153224543](image-20250305153224543.png))

#### 2.11.2 输入需求
![image-20250305153310702](image-20250305153310702.png))
...
#### 2.11.3 追踪
![image-20250305153638624](image-20250305153638624.png))

可以追踪每个节点的运行情况

点开迭代节点可以查看每个子节点的运行情况
![image-20250305153725783](image-20250305153725783.png))
![image-20250305154428200](image-20250305154428200.png))

#### 2.11.4 查看运行历史
![image-20250305154323188](image-20250305154323188.png))
...
##### 1. 追踪
![image-20250305155024254](image-20250305155024254.png))

##### 2. 详情
![image-20250305155039878](image-20250305155039878.png))
...
### 2.12 发布
![image-20250812142553850](image-20250812142553850.png))
