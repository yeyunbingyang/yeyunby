...
| 文档 | 内容 |
|------|------|
| [架构设计](02-Knowledge(知识层)/20-核心能力-Core_Ability/00%20AI/01%20AI工具/02%20Agent/04%20Hermes-Agent/项目实战/05-社交媒体舆情监控Agent/docs/01-架构设计.md) | 系统架构、数据流、模块划分 |
| [环境搭建](02-Knowledge(知识层)/20-核心能力-Core_Ability/00%20AI/01%20AI工具/02%20Agent/04%20Hermes-Agent/项目实战/05-社交媒体舆情监控Agent/docs/02-环境搭建.md) | 安装配置、Hermes 设置、Gateway 配置 |
| [核心流程](02-Knowledge(知识层)/20-核心能力-Core_Ability/00%20AI/01%20AI工具/02%20Agent/04%20Hermes-Agent/项目实战/05-社交媒体舆情监控Agent/docs/03-核心流程.md) | 监控流程、情感分析、预警、日报 |
| [踩坑记录](02-Knowledge(知识层)/20-核心能力-Core_Ability/00%20AI/01%20AI工具/02%20Agent/04%20Hermes-Agent/项目实战/05-社交媒体舆情监控Agent/docs/04-踩坑记录.md) | 常见问题、解决方案、优化建议 |
| [扩展思路](02-Knowledge(知识层)/20-核心能力-Core_Ability/00%20AI/01%20AI工具/02%20Agent/04%20Hermes-Agent/项目实战/05-社交媒体舆情监控Agent/docs/05-扩展思路.md) | 更多平台、高级分析、多 Agent 协作 |
