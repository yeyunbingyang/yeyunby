...
> 📖 详细步骤请参阅 [docs/02-环境搭建.md](02-Knowledge(知识层)/20-核心能力-Core_Ability/00%20AI/01%20AI工具/02%20Agent/04%20Hermes-Agent/项目实战/09-AI短视频自动生成与发布Agent/docs/02-环境搭建.md)
...
| 文档 | 内容 |
|------|------|
| [01-架构设计.md](02-Knowledge(知识层)/20-核心能力-Core_Ability/00%20AI/01%20AI工具/02%20Agent/04%20Hermes-Agent/项目实战/09-AI短视频自动生成与发布Agent/docs/01-架构设计.md) | 系统架构、模块划分、数据流、技术选型 |
| [02-环境搭建.md](02-Knowledge(知识层)/20-核心能力-Core_Ability/00%20AI/01%20AI工具/02%20Agent/04%20Hermes-Agent/项目实战/09-AI短视频自动生成与发布Agent/docs/02-环境搭建.md) | 环境准备、依赖安装、平台配置、技能注册 |
| [03-核心流程.md](02-Knowledge(知识层)/20-核心能力-Core_Ability/00%20AI/01%20AI工具/02%20Agent/04%20Hermes-Agent/项目实战/09-AI短视频自动生成与发布Agent/docs/03-核心流程.md) | 热点追踪→脚本→配音→合成→发布→回采全流程 |
| [04-踩坑记录.md](02-Knowledge(知识层)/20-核心能力-Core_Ability/00%20AI/01%20AI工具/02%20Agent/04%20Hermes-Agent/项目实战/09-AI短视频自动生成与发布Agent/docs/04-踩坑记录.md) | 实际开发中遇到的问题与解决方案 |
| [05-扩展思路.md](02-Knowledge(知识层)/20-核心能力-Core_Ability/00%20AI/01%20AI工具/02%20Agent/04%20Hermes-Agent/项目实战/09-AI短视频自动生成与发布Agent/docs/05-扩展思路.md) | 功能扩展、性能优化、商业化方向 |
