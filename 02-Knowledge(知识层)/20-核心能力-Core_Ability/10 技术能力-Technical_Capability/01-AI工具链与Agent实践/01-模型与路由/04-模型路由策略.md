...
related: ["00-主流模型对比", "模型与路由-MOC", "01-9router-快速入门手册", "02-CC-Switch-模型管理器", "03-omniRoute-使用指南"]
source: "https://developers.openai.com/api/docs/models; https://platform.claude.com/docs/en/about-claude/models/overview; https://github.com/diegosouzapw/OmniRoute"
---
...
| **OmniRoute** | 智能网关 | 运行时决策+负载均衡+压缩 | 需要多供应商回退与统一观测的环境（250个供应商） |
...
| 📋 一般（业务数据） | 按组织数据策略选择 | 经组织批准的云端模型 | 合规取决于地区、合同、数据驻留与组织制度 |
...
- [[Agent学习与Vibe-Coding完全指南|完全指南]] — 第7章 OmniRoute、第16章价格策略
