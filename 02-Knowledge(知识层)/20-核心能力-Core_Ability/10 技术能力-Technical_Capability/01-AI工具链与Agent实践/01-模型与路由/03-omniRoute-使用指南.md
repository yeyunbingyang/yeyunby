...
summary: "OmniRoute v3.8.49 通过250个供应商、18种路由策略和多级回退统一管理模型调用，并提供压缩、MCP与可观测能力"
source: "https://github.com/diegosouzapw/OmniRoute"
related: ["04-模型路由策略", "01-9router-快速入门手册", "02-CC-Switch-模型管理器", "模型与路由-MOC", "MCP-企业级应用与本地部署"]
---

# OmniRoute 完全指南

> **版本：v3.8.49** | 28,423⭐（核验于 2026-07-25） | MIT 开源
>
> 免费 AI 网关：一个端点，250 个供应商，90+ 免费，~1.6B 有文档依据的免费 Token/月。
...
| 指标 | 数值 | 备注 |
|------|------|------|
| **供应商** | 250 | 从 OpenAI 到本地 Ollama |
| **免费供应商** | 90+（11 个永久免费） | 无需信用卡 |
| **免费 Token/月** | ~1.6B | 官方按共享池去重后的文档口径；首月含注册赠额最高约 ~2.1B |
| **模型数** | 500+ | 官方 README 当前免费层目录口径 |
| **路由策略** | 18 种 | priority / weighted / cost-optimized / fusion… |
| **MCP 工具** | 94 | 3 传输方式，30 作用域 |
| **压缩率** | 15-95%（平均 ~89%） | RTK + Caveman 堆叠 |
| **多语言** | 43 种 | 含简体中文 |
| **GitHub Stars** | 28,423 | 核验于 2026-07-25，后续以仓库实时数据为准 |
...
- [[MCP-企业级应用与本地部署]] — MCP 企业级应用与本地部署指南
- [[Agent学习与Vibe-Coding完全指南|完全指南]] — 第7章 OmniRoute 完整配置
