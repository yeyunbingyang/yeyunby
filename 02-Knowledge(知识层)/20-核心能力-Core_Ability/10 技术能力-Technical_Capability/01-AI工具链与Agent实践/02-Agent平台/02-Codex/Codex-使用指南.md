...
> [!note] 原文截图记录
> 原附件 `Pasted image 20260723162839.png` 当前未存入仓库；保留文件名以便后续补回。

- 或者用**API key**登录（需要额外购买）

> [!note] 原文截图记录
> 原附件 `Pasted image 20260723162847.png`、`Pasted image 20260723162914.png` 当前未存入仓库；保留文件名以便后续补回。
...
> [!warning] 原文配图待补回
> 下文 `images-wx` 配图未随原笔记进入仓库。为避免伪造截图，当前位置保留原附件路径，正文内容不删减。

〔原文截图缺失：images-wx/img04.png〕
...
〔原文截图缺失：images-wx/img05.png〕

**步骤 2**：压缩上下文

- 可通过输入中文指令`/压缩`进行手动压缩

〔原文截图缺失：images-wx/img06.png〕

### 2. 额度状态

#### 方式 1：系统设置查看

〔原文截图缺失：images-wx/img07.png〕

#### 方式 2：斜杠命令查看

〔原文截图缺失：images-wx/img08.png〕〔原文截图缺失：images-wx/img09.png〕

### 3. 模型选择

〔原文截图缺失：images-wx/img10.png〕
...
〔原文截图缺失：images-wx/img12.png〕

**步骤 3**：项目内任务多开

- 支持在现有项目任务中，额外开启并行的对话任务

〔原文截图缺失：images-wx/img13.png〕
...
〔原文截图缺失：images-wx/img14.png〕

> **Codex的一个缺点：**目前「**聊天任务框**」里显示的文件，可在右侧「**结果框**」内打开，但**无法编辑**
>
> 〔原文截图缺失：images-wx/img15.png〕
>
...
>
> 〔原文截图缺失：images-wx/img16.png〕〔原文截图缺失：images-wx/img17.png〕
...
〔原文截图缺失：images-wx/img18.png〕〔原文截图缺失：images-wx/img19.png〕

**步骤 2：**直接在「**自定义指令**」里添加想要的规则和约束，比如个人使用习惯、工作偏好等。

〔原文截图缺失：images-wx/img20.png〕

**步骤 3：**也可直接在聊天任务中使用日常语言交代自己的规则，并最终要求添加到「**全局agents.md**」

〔原文截图缺失：images-wx/img21.png〕
...
〔原文截图缺失：images-wx/img22.png〕

**步骤 2**：在编辑器中新建文件，并命名为：**AGENTS.md**。（**注意**：AGENTS必须大写）

〔原文截图缺失：images-wx/img23.png〕
...
〔原文截图缺失：images-wx/img40.png〕

**步骤 6**：可通过斜杠命令进行调出并使用这个skill

〔原文截图缺失：images-wx/img41.png〕
...
〔原文截图缺失：images-wx/img42.png〕〔原文截图缺失：images-wx/img43.png〕
...
〔原文截图缺失：images-wx/img44.png〕〔原文截图缺失：images-wx/img45.png〕

**步骤 3**：在「**设置**」下的「**MCP服务器**」确认下载成功

〔原文截图缺失：images-wx/img46.png〕
...
〔原文截图缺失：images-wx/img47.png〕

**步骤 2**：新建自动化功能 / 选择需求相近的官方样例

〔原文截图缺失：images-wx/img48.png〕

**步骤 3**：完成自动化任务设置

〔原文截图缺失：images-wx/img49.png〕
...
- [[Codex-插件与技能系统]] — 插件和 Skills 详解
- [[Vibe-Coding视频创作场景]] — 视频创作场景
