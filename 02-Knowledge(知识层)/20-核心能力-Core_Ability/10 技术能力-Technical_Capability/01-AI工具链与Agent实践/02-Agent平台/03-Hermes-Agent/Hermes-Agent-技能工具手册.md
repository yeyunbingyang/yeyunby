...
related:
  - "[[03-Resources(资源层)/00 Github优质项目/01-Agent引擎/03-hermes-agent-成长型AI代理|Hermes Agent 项目]]"
  - "[[Obsidian-Agent操作指南|Obsidian Agent 操作指南]]"
...
> 项目笔记见：[[03-Resources(资源层)/00 Github优质项目/01-Agent引擎/03-hermes-agent-成长型AI代理|Hermes Agent GitHub 项目]]
