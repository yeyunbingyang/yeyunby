...
created: 2026-07-22
updated: 2026-07-23
summary: "17章+附录完整体系——六层金字塔结构(认知→资源→实战→进阶→企业→参考)，从零基础到Agent实战，本库最大知识资产"
source: "知识库内部蒸馏；关键动态数据以正文官方链接为准"
related: []
verified: 2026-07-25
...
> **整理日期**: 2026-07-22
> **版本**: v3.0（重构版 — 六层金字塔结构：认知→资源→实战→进阶→企业→参考，2026-07-23）
...
## 目录
  ...
  1. [一、核心概念全景](#一、核心概念全景)
  2. [二、AI编程发展历程](#二、AI编程发展历程)
  3. [三、LLM模型全景矩阵](#三、LLM模型全景矩阵)
  4. [四、CLI Agent工具对比](#四、CLI-Agent工具对比)
  5. [五、AI编程零基础入门](#五、AI编程零基础入门)
  6. [六、提示词工程完全指南](#六、提示词工程完全指南)
  7. [七、Vibe Coding实战](#七、Vibe-Coding实战)
  8. [八、Skills深度实践](#八、Skills深度实践)
  9. [九、本地模型部署指南](#九、本地模型部署指南)
  10. [十、OmniRoute网关完全配置](#十、OmniRoute网关完全配置)
  11. [十一、MCP深度解析](#十一、MCP深度解析)
  12. [十二、团队级Agent工作流](#十二、团队级Agent工作流)
  13. [十三、联网搜索与合规限制](#十三、联网搜索与合规限制)
  14. [十四、价格策略与成本优化](#十四、价格策略与成本优化)
  15. [十五、Github优质项目生态](#十五、Github优质项目生态)
  16. [十六、中国订阅GPT/Claude](#十六、中国订阅GPT/Claude)
  17. [十七、快速决策速查卡](#十七、快速决策速查卡)
  18. [十八、附录](#十八、附录)
...
> 从代码补全到自主Agent的三次范式跃迁，理解AI编程的本质变化。
...
|------|------|---------------|-------|------|
| **OmniRoute** | 智能路由+负载均衡+故障转移 | 250 AI 提供商 | ~1.6B Token/月 | v3.8.49 |
...
**Hermes 实战项目一览**（共9个项目，位于 02 工具链/03 Hermes-Agent/项目实战/）：
...
### 4.10 Codex Desktop vs Claude Code
...
> 📌 关于"什么是AI编程"与传统编程的对比，见 [[#二、AI编程发展历程与入门|第二章 AI编程发展历程]]。
...
参考：[[03-通用skills最佳实践|通用skills最佳实践]]
...
> **对本知识库读者**：本指南与 [[AI工具链与Agent实践-MOC]] 下的 96 篇知识笔记互相补充，外部项目索引见收录 282 个项目的 [[Github优质项目-MOC]]。如需深入了解特定 Agent 或工具，请进入对应子 MOC。
...
### 8.2 Skills 体系全景（基于本知识库）

当前知识库中已整理的 Skills 体系：

| 类别 | Skills 内容 | 目录位置 |
|------|------------|---------|
| **Claude 官方 Skills** | Obsidian 系列（Bases/CLI/Markdown/Vault） | 02 工具链/00 基础设施/skills/Claude-Skills |
| **数据获取 Skills** | Python 爬虫、浏览器自动化、Agent 数据获取 | 02 工具链/00 基础设施/skills/数据获取 |
| **通用 Skills** | Karpathy 四大原则、Skills 生态全景、调用机制 | 02 工具链/00 基础设施/skills |
| **Hermes 实战 Skills** | 博客发布、智能客服、CI/CD、代码审查等 | 02 工具链/03 Hermes-Agent |
| **Codex Skills** | 插件与技能系统 | 02 工具链/02 Codex |
...
> 关键数据: vLLM 在 50 用户并发下可达 920 tok/s，p99 延迟约 2.8s；Ollama 同条件下约 41 tok/s。完整模型矩阵见 [[00-主流模型对比]]。
...
OmniRoute（智能网关）
  ...
  -> 支持 250 个 AI 提供商，90+ 免费层级，~1.6B 有文档依据的免费 Token/月
  -> 内置 94 个 MCP 工具
...
### 10.3 Web Cookie Provider 与 API Key 对比
...
> 更多案例（医疗RAG、微信支付MCP）已精简，核心模式相同：MCP 标准化工具接口 + 领域专业知识。
### 11.12 企业级 MCP 开发 Checklist
...
+-----------------------------------------------------------+
|  第二层：国内低价（$0-20/月）                               |
|  -> DeepSeek V4 Pro ($0.43/1M) / Kimi K3 ($3/1M)        |
|  -> 中文处理、长文本、常规开发、国内网络稳定                 |
+-----------------------------------------------------------+
|  第三层：国外高端（$0-200/月，按需）                       |
|  -> Claude Fable 5 ($10/1M) / GPT-5.6 Sol ($5/1M)       |
...
> 完整工具链架构图已在第一章 1.1 概念关系链中展示，此处不再重复。
### A.5 命令速查表
