...
- **链接**：[[05-anthropics-skills-官方Skills仓库]]
...
- **链接**：[[01-mattpocock-skills-工程师日常技能]]
...
- **链接**：[[04-andrej-karpathy-skills-四大原则指南]]
...
- **链接**：[[15-knowledge-work-plugins-知识工作角色插件]]

#### agency-agents（105k★）— 社区角色库

- **定位**：社区版角色库，从工程到市场/运营/Reddit 社区管理全覆盖
- **链接**：[[07-agency-agents-完整AI机构角色库]]
...
- **链接**：[[25-mindrally-skills-全技术栈技能集合]]
...
- **链接**：详见 [[11-obsidian-skills-Obsidian官方开发者kepano出品的AI|Obsidian Skills 项目笔记]]
...
- **链接**：[[03-Resources(资源层)/00 Github优质项目/07-浏览器自动化与测试/07-opencli-网站CLI桥接工具|opencli 网站 CLI 桥接工具]]
