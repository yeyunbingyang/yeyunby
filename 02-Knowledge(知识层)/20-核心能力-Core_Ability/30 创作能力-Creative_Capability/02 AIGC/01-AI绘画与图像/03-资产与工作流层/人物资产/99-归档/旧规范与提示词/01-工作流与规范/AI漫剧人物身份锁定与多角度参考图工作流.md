...
| [[AI人物身份参考资产库-MOC#快速任务入口|提示词入口]] | GPT、即梦、负面词和失败修复的直贴模板 |
| [[验收与失败修复规范]] | 评分、门禁、命名、排版和交付检查 |
| [[AI人物身份参考资产库-MOC#角色与实验|角色案例入口]] | 单图、多图、全身三视图的实测结果与图片 |
...
中国本土特色组至少覆盖：水墨写意、工笔重彩、敦煌壁画、剪纸、皮影、年画/木版套色、京剧装饰、白描线描、青绿山水幻想和当代国潮3D。完整调研与适用边界见[[风格与作品研究#八、中国本土动画视觉体系调研]]。
...
完整提示词见[[AI人物身份参考资产库-MOC#快速任务入口|提示词入口]]。
...
实测图片与评分见[[AI人物身份参考资产库-MOC#角色与实验|角色案例入口]]。
