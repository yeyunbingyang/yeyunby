...
| [[角色生产方法-MOC|角色生产方法]] | GPT、即梦、负面词和失败修复的直贴模板 |
| [[验收与失败修复规范]] | 评分、门禁、命名、排版和交付检查 |
| [[角色项目-MOC|角色项目入口]] | 单图、多图、全身三视图的实测结果与图片 |
...
“保持100%一致”“绝对锁脸”属于目标语言，不是可验证参数。实际以[[验收与失败修复规范]]的评分、硬性否决项和阶段门禁判断。
...
中国本土特色组至少覆盖：水墨写意、工笔重彩、敦煌壁画、剪纸、皮影、年画/木版套色、京剧装饰、白描线描、青绿山水幻想和当代国潮3D。完整调研与适用边界见[[风格与作品研究-MOC|风格与作品研究]]。
