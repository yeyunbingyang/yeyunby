...
created: 2026-05-26
updated: 2026-07-16
summary: "GitHub 优质开源项目汇总（282个），覆盖14个子域：Agent引擎(15)/Agent配置与Skills(26)/AI应用与学习(13)/AI开发框架(18)/ML引擎与模型(15)/视频创作与设计(23)/浏览器自动化与测试(8)/安全与隐私(18)/终端效率工具(37)/代码质量与构建(6)/数据与存储(33)/DevOps与云原生(32)/前端框架与UI(27)/后端与全栈(11)"
---
...
> 📌 每个分类内部按 Star 数降序排列。2026-07-16 更新：从 17 分类精简优化为 14 分类。
...
| # | 分类 | 数量 | 最亮项目 |
|---|------|------|---------|
| 01 | [[Github优质项目-MOC#01-Agent引擎\|Agent引擎]] | 15 | OpenClaw(374k)/claw-code(192k)/Aider(70k) |
| 02 | [[Github优质项目-MOC#02-Agent配置与Skills\|Agent配置与Skills]] | 26 | Superpowers(207k)/ECC(193k)/MattPocock(170k) |
| 03 | [[Github优质项目-MOC#03-AI应用与学习\|AI应用与学习]] | 13 | awesome-llm-apps(120k)/ai-hedge-fund(61k) |
...
| 06 | [[Github优质项目-MOC#06-视频创作与设计\|视频创作与设计]] | 23 | MoneyPrinter(94k)/manim(88k)/penpot(56k) |
...
| 09 | [[Github优质项目-MOC#09-终端与效率工具\|终端与效率工具]] | 37 | ohmyzsh(180k)/markitdown(165k)/Bun(94k) |
| 10 | [[Github优质项目-MOC#10-代码质量与构建\|代码质量与构建]] | 6 | Webpack(65k)/spec-kit(120k)/Prettier(50k) |
...
| 09-开发者工具 | **拆分**为 09-终端与效率工具 + 10-代码质量与构建 |
| 13-AI工具与框架 + 17-AI模型与推理 | **拆分**为 04-AI开发框架 + 05-ML引擎与模型 |
| 14-前端与UI | **拆分**为 13-前端框架与UI + 10-代码质量与构建 |
