...
| 项目 | 值 |
|------|----|
| **项目路径** | `03-Resources(资源层)\05-AI工具\示例项目\product-launch-video\` |
...
```bash
# 进入项目目录
cd "X:\KMS\yeyunby\03-Resources(资源层)\05-AI工具\示例项目\product-launch-video"
...
- [[Vibe-Coding视频创作场景]] — 同目录下的 vibe coding 场景列表
