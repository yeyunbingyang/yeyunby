...
summary: 事件监听通过 addEventListener 注册事件处理函数。事件类型包括鼠标事件（click/mouseenter/mouseleave）、焦点事件（focus/blur）、键盘事件（keydown/keyup/input）。事件对象 e 包含触发信息，this 指向调用函数的对象。排他思想用于突出显示当前元素。
---
...
![](https://cdn.nlark.com/yuque/0/2025/png/40487410/1747576906206-465031b3-b40c-455e-87bd-c6e9b45435e6.png "null")
...
回调函数是**作为参数传递给另一个函数**的函数，在该函数**执行完毕后被调用**。
...
2. DOM 2事件【推荐·】事件源.addEventListener(事件类型，事件处理函数)
...
![](https://cdn.nlark.com/yuque/0/2025/png/40487410/1747576906266-6c136d5b-83e5-428d-a8b1-163ee952adc8.png "null")
...
![](https://cdn.nlark.com/yuque/0/2025/png/40487410/1747576906326-fd6720e3-0e08-40e6-a8d1-c2091e2cc2d9.png "null")
...
![](https://cdn.nlark.com/yuque/0/2025/png/40487410/1747576906385-ad0e63f8-fa1a-4ffd-8f48-ff8afdc766ae.png "null")
