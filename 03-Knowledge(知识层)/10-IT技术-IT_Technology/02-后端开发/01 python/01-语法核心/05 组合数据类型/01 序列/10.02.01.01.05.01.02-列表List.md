...
- List（列表）是 Python 中使用最频繁的数据类型，在其他语言中通常叫做**数组**、专门用于存储一串信息
- 列表用 [ ] 定义，数据之间使用，分隔
- 列表的索引从 0 开始
...
![[Pasted image 20260613004108.png]]
```python
#  创建空列表、类似Java中的数组
list = []
...
![[Pasted image 20260613004513.png]]
...
> [!NOTE]
> 将一个可迭代对象（如列表、元组、集合、字符串等）的元素通过某种运算或条件筛选后生成一个新的列表。
...
![[Pasted image 20260613005025.png]]
![[Pasted image 20260613005035.png]]
...
[![](https://github.com/jackfrued/Python-100-Days/raw/master/Day01-20/res/day09/lottery_run_result.png)![[Pasted image 20260613005134.png]]
![[Pasted image 20260613005126.png]]
...
![[Pasted image 20260613005154.png]]
...
![[Pasted image 20260613005216.png]]

![[Pasted image 20260613005211.png]]
