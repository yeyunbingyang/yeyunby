...
![](https://cdn.nlark.com/yuque/__latex/f74081b8b54292400bbd95f872998aff.svg)

你可能已经想到了，这个问题其实等同于将 8 个苹果分成四组且每组至少一个苹果有多少种方案，也等价于在分隔 8 个苹果的 7 个间隙之间放入三个隔断将苹果分成四组有多少种方案，所以答案是 ![](https://cdn.nlark.com/yuque/__latex/f4d4f0b2fe0a0a120050e33fa113fa42.svg) ，其中 ![](https://cdn.nlark.com/yuque/__latex/f1fa3432298a64b1e030895d96a7aa37.svg) 代表 7 选 3 的组合数，其计算公式如下所示。

![](https://cdn.nlark.com/yuque/__latex/cb8987acdbcc075a641263b40079f8e1.svg)

根据之前学习的知识，我们可以用循环做累乘的方式分别计算出 ![](https://cdn.nlark.com/yuque/__latex/6ac4f32ad7b233ea12e7156117971c43.svg) 、 ![](https://cdn.nlark.com/yuque/__latex/7fa7dad57be8da49a9227198676759f2.svg) 和 ![](https://cdn.nlark.com/yuque/__latex/48d7194c2bab9610b2ce16a86427f477.svg) ，然后再通过除法运算得到组合数 ![](https://cdn.nlark.com/yuque/__latex/d99fb955a79e3a1449f880f77581d6c3.svg) ，代码如下所示。
...
不知大家是否注意到，上面的代码中我们做了三次求阶乘的操作，虽然 ![](https://cdn.nlark.com/yuque/__latex/90e1ffe350b14e020eb94f045ee04df6.svg) 、 ![](https://cdn.nlark.com/yuque/__latex/1078a502edb0a57704d7929280e20faf.svg) 、 ![](https://cdn.nlark.com/yuque/__latex/87dc3920aff2a537d62e57d40f424606.svg) 的值各不相同，但是三段代码并没有实质性的区别，属于重复代码。世界级的编程大师_Martin Fowler_曾经说过：“**代码有很多种坏味道，重复是最坏的一种！**”。要写出高质量的代码，首先就要解决重复代码的问题。对于上面的代码来说，我们可以将求阶乘的功能封装到一个称为“函数”的代码块中，在需要计算阶乘的地方，我们只需“调用函数”即可实现对求阶乘功能的复用。

### 定义函数

数学上的函数通常形如 ![](https://cdn.nlark.com/yuque/__latex/79e256ecbf3d53bcde0a8908dd60d70e.svg) 或者 ![](https://cdn.nlark.com/yuque/__latex/1b7b755abe69a93916f0b08a85d6a367.svg) 这样的形式，在 ![](https://cdn.nlark.com/yuque/__latex/79e256ecbf3d53bcde0a8908dd60d70e.svg) 中， ![](https://cdn.nlark.com/yuque/__latex/c100c311cda315f2d6c701e0c7ad1620.svg) 是函数的名字， ![](https://cdn.nlark.com/yuque/__latex/147d40d49bc0c8434b88e37d47c8f056.svg) 是函数的自变量， ![](https://cdn.nlark.com/yuque/__latex/61b8a0fd862c2afe3a5a95b80204af4a.svg) 是函数的因变量；而在 ![](https://cdn.nlark.com/yuque/__latex/1b7b755abe69a93916f0b08a85d6a367.svg) 中， ![](https://cdn.nlark.com/yuque/__latex/3668698fab55e3321b7302d8ee509981.svg) 是函数名， ![](https://cdn.nlark.com/yuque/__latex/147d40d49bc0c8434b88e37d47c8f056.svg) 和 ![](https://cdn.nlark.com/yuque/__latex/61b8a0fd862c2afe3a5a95b80204af4a.svg) 是函数的自变量， ![](https://cdn.nlark.com/yuque/__latex/9fd441be8869e5f7c7ebf06ded928a2d.svg) 是函数的因变量。Python 中的函数跟这个结构是一致的，每个函数都有自己的名字、自变量和因变量。我们通常把 Python 函数的自变量称为函数的参数，而因变量称为函数的返回值。
...
![](https://cdn.nlark.com/yuque/0/2025/png/40487410/1741332004874-1462377d-f433-40ad-8b53-8bc72f704c15.png)
...
如果**不想按照从左到右的顺序依次**给出`a`、`b`、`c` 三个参数的值，也可以使用关键字参数，通过“参数名=参数值”的形式为函数传入参数，如下所示。
...
下面的代码演示了如何使用可变位置参数实现对任意多个数求和的`add`函数，调用函数时传入的参数会保存到一个元组，通过对该**元组**的遍历，可以获取传入函数的参数。
...
如果我们希望通过“参数名=参数值”的形式传入若干个参数，具体有多少个参数也是不确定的，我们还可以给函数添加可变关键字参数，把传入的关键字参数组装到一个**字典**中，代码如下所示。
...
在导入模块时，还可以使用`as`关键字对模块进行**别名**，这样我们可以使用更为简短的完全限定名。
...
![](https://cdn.nlark.com/yuque/0/2025/png/40487410/1761547203342-fb93d070-3eb2-42ac-928e-1165fde6be54.png)

![](https://cdn.nlark.com/yuque/0/2025/png/40487410/1761547267311-ed68caac-80f4-4dd5-865a-a3a464c16082.png)

![](https://cdn.nlark.com/yuque/0/2025/png/40487410/1761547300422-8a91f9c8-12ad-46de-bbd1-5e91dc6c99ba.png)

![](https://cdn.nlark.com/yuque/0/2025/png/40487410/1761547319838-3e97b79d-9ccc-470d-b9f2-d30d3c2d760e.png)
